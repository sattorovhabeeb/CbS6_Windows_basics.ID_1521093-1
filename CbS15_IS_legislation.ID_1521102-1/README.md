...
2. [Chapter II](#chapter-ii) \
   2.1. [Законодательство в области ИБ](#законодательство-в-области-иб)
3. [Chapter III](#chapter-iii) \
   3.1. [Задание 1. Нормативные акты](#задание-1-нормативные-акты) \
   3.2. [Задание 2. Российское и международное законодательство](#задание-2-российское-и-международное-законодательство) \
   3.3. [Задание 3. Категории и уровни защищенности](#задание-3-категории-и-уровни-защищенности)
...
_Важно! Если системы пересекаются (например, ГИС, которая занимается обработкой перс. данных), то класс защиты для такой системы высчитывается по отдельным метрикам. Процесс высчитывания прописан в соответствующих нормативных документах и приказах._
